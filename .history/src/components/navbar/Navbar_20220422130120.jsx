    ...
    <div className="container">
      ...
      <Link className="link" to="/" ><img className="verif-logo" src={verifLogo} alt="verif-logo" /></Link>
        ...
        <ul className="navLink">
            ...
            <li><Link style={navLinkStyles} className="link" to="/" >  Home </Link></li>
      
            <li><NavLink style={navLinkStyles} className="link"  to="/contact">Contact   </NavLink></li>
      
            <li>  <Link style={navLinkStyles} className="link" to="/about">About Us   </Link></li>

            <li><Link  style={navLinkStyles} className="link" to="/contact">Pricing  </Link></li>
