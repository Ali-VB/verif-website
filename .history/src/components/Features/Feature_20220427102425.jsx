            ...
            <div className="leftPart text-secondary fw-light ">
              <Fade delay={500} duration={1500} top cascade>
                <ul class=" fw-light  text-secondary">
                  <li>
                    <span>CEO Impersonation</span>{" "}
                  </li>
                  <li>
                    <span>Provider Impersonation</span>
                  </li>
                  <li>
                    <span>Dangerous files detection</span>
                  </li>
                  <li>
                    <span>Email Address Blacklist</span>
                  </li>
                  <li>
                    <span>URL Blacklist</span>
                  </li>
                  <li>
                    <span>DKIM/DMARC/SPF failure</span>
                  </li>
                  <li>
