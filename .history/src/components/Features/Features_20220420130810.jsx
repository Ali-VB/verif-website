    ...
    <div>
      ...
      <div className="features-section">
        ...
        <div class="container ">
          ...
          <div class="row g-0">
            <div class="col-sm-6 col-md-6  col-lg-3 ">
              <div class="p-4   cell p-3 border border-2 display-6 text-center text-secondary">
                URL Blacklist
              </div>
            </div>
            <div class=" col-sm-6 col-md-6  col-lg-3 ">
            ...
            <div class="col-sm-6 col-md-6  col-lg-3 ">
              <div class=" p-1 cell  border border-2 display-6 fs-3 text-center text-secondary">
