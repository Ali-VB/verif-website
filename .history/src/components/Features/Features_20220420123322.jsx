    ...
    <div>
      ...
      <div className="features-section">
        ...
        <div class="container ">
          ...
          <div class="row g-0">
            <div class="col-3 ">
              <div class="p-3  border-end text-center border-2 display-6 text-secondary">
                URL Blacklist
              </div>
            </div>
            <div class="col-3 ">
              <div class="p-3   border-start border-end  border-2 display-6 text-center fs-2 text-secondary">
            ...
            <div class="col-3 ">
              <div class="p-3  border-2 display-6 text-center text-secondary">More ...</div>
            </div>
          </div>
        </div>
      </div>
