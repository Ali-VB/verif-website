...
const Features = () => {
  return (
    <div>
      ...
      <div class="row g-0">
        <div class="col-3">
          <div class="p-3 border-bottom border-end  border-2 display-5 text-center ">
          CEO Impersonation
          </div>
        </div>
        <div class="col-3">
        ...
        <div class="col-3">
          <div class="p-3 border-bottom   border-2 display-6 ">Email Address Blacklist</div>
        </div>
      </div>

      <div class="row g-0">
        <div class="col-3">
          <div class="p-3  border-end  border-2 display-6 ">URL Blacklist</div>
        </div>
        <div class="col-3">
        ...
        <div class="col-3">
          <div class="p-3  border-2 display-6 ">More ...</div>
        </div>
      </div>
    </div>
      </div>
