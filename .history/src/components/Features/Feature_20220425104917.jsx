        ...
        <div className="leftPart text-secondary fw-light ">
          <Fade delay={500} duration={1500} top cascade>
            <ul class=" fw-light  text-secondary">
              ...
              <li><span>Provider Impersonation</li>
              <li><span>Dangerous files detection</li>
              <li><span>Email Address Blacklist</li>
              <li><span>URL Blacklist</li>
              <li><span>DKIM/DMARC/SPF failure</li>
