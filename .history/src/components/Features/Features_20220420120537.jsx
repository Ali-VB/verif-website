...
const Features = () => {
  return (
    <div>
      ...
      <div class="row g-0">
        <div class="col-3">
          <div class="p-3 border-bottom border-end  border-2 display-6 ">
          CEO Impersonation
          </div>
        </div>
        <div class="col-3">
        ...
        <div class="col-3">
          <div class="p-3 border-bottom border-end  border-2 display-6 fs-3">
          Dangerous files detection
          </div>
        </div>
        <div class="col-3">
          <div class="p-3 border-bottom   border-2 display-6 fs-3">Email Address Blacklist</div>
        </div>
      </div>

      <div class="row g-0">
        <div class="col-3">
          <div class="p-3  border-end  border-2 display-6 fs-3">URL Blacklist</div>
        </div>
        <div class="col-3">
          <div class="p-3  border-end  border-2 display-6 fs-3">
        ...
        <div class="col-3">
          <div class="p-3  border-2 display-6 fs-3">More ...</div>
        </div>
      </div>
    </div>
      </div>
