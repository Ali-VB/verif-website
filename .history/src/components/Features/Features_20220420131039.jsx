  ...
  return (
    <div>
      ...
      <div className="features-section">
        ...
        <div class="container ">
          <div class="row g-0">
            <div class=" cell col-sm-6 col-md-6 col-lg-3 ">
              <div class="cell p-3 border border-2 display-6 text-center text-secondary">
                CEO Impersonation
              </div>
            </div>
          ...
          <div class="row g-0">
            <div class="col-sm-6 col-md-6  col-lg-3 ">
              <div class="p-5   cell p-3 border border-2 display-6 text-center fs-3 text-secondary">
                URL Blacklist
              </div>
            </div>
            <div class=" col-sm-6 col-md-6  col-lg-3 ">
              <div class="p-3  cell  border border-2 display-6 text-center fs-3 text-secondary">
                DKIM/DMARC/SPF failure
              </div>
            </div>
            <div class="col-sm-6 col-md-6  col-lg-3 ">
              <div class=" p-3 cell  border border-2 display-6 fs-3 text-center text-secondary">
                Language analysis using A.I.
              </div>
            </div>
            <div class="col-sm-6 col-md-6  col-lg-3 ">
              <div class="p-3  cell p-3 border border-2 display-6 text-center text-secondary">
                More ...
              </div>
            </div>
          </div>
