  ...
  return (
    <div className="header-animated">
      <h1 className="h1">
        ...
        <span className="text-span">intrusion</span>
        <span className="text-span">activity</span>
        <span className="text-span">jumped</span>
        <span className="text-span">125% in 2021</span>
      </h1>
      <div className="h3">
