    ...
    <div className="container">
      <div class="row about-section">
        ...
        <div className="col-4 photo-grid">
          <div class="photo1"><img src={team1} alt="" /></div>
          <div class="photo2"><img src={team2} alt="" /></div>
          <div class="photo3"><img src={team1} alt="" /></div>
          <div class="photo4"><img src={team5} alt="" /></div>
          <div class="photo5"><img src={team1} alt="" /></div>
        </div>
      </div>
    </div>
  );
