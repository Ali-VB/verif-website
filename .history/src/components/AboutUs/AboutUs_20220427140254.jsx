  ...
  return (
    <div className="container">
      <div class="row about-section">
        <div class="col-lg-8 col-md-12 contact-section-left">
          <div>About Us</div> 
          <div className="contact-section-left-mainTxt mt-3">
            <span className=" fw-bold verif-span"> Verifa.i.</span> <span>is a Montreal-based
            ...
            also language thanks to a proprietary artificial intelligence model.</span>
          </div>
        </div>

        <div className="col-lg-4 col-md-12 photo-grid">
