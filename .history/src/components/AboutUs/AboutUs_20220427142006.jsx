      ...
      <div class=" about-section">
        <div class=" contact-section-left"><div></div>
          ...
          <div className="contact-section-left-mainTxt mt-3">
            <div className="  verif-span"> Verifa.i.</div> <div>is a Montreal-based
            ...
            cybercriminals.<br></br>br Our Decision Support tool evaluates the risk
            ...
            also language thanks to a proprietary artificial intelligence model.</div>
          </div>
        </div>
