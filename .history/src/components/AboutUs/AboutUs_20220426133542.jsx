    ...
    <div className="container">
      <div class="row about-section">
        ...
        <div class="photo1" ><ImageZoom src={team1} zoom={zoom.current} color="#BADA55"/></div>
          <div class="photo2"><ImageZoom src={team1} zoom={zoom.current} color="#BADA55"/></div>
          <div class="photo3"><ImageZoom src={team1} zoom={zoom.current} color="#BADA55"/></div>
          <div class="photo4"><ImageZoom src={team1} zoom={zoom.current} color="#BADA55"/></div>
          <div class="photo5"><ImageZoom src={team1} zoom={zoom.current} color="#BADA55"/></div>
        </div>
      </div>
    </div>
  );
